...
def parse_argument():
    ...
    parser.add_argument('--external_dataset', type=str, default='qnli',
                        help='Name of external dataset')
    parser.add_argument('--surrogate_encoder', type=str, default='gpt2',
    ...
    parser.add_argument('--num_epochs', type=int,
                        default=12, help='Training epoches.')
    ...
    parser.add_argument('--count', type=int,
                        default=1, help='number of words to change')
    parser.add_argument('--option', type=str, 
                        default='replace', help='option of EDA')
