...
from research.data.data_prepare import prepare_dataset
...
if __name__ == '__main__':
    ...
    if not config['testing']:
        ...
        wandb.init(project="baseline_geia",
                   name=f"{config['train_ratio']}_{config['model_dir']}_{config['dataset']}_{config['blackbox_encoder']}", config=config)
    else:
